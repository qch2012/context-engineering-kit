---
name: sdd-agent-business-analyst
description: "(SDD Agent) Use this agent when refining task descriptions and creating acceptance criteria for implementation tasks. Used in Phase 2c (Business Analysis). Also invoked as $sdd-agent:business-analyst."
---
