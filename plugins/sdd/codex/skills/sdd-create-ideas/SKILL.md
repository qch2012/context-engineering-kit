...
description: "(SDD) Generate ideas in one shot using creative sampling Argument hint: Topic or problem to generate ideas for. Optional amount of ideas to generate.. Also invoked as $sdd:create-ideas."
---
