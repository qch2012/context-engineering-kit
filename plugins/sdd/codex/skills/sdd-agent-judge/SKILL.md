---
name: sdd-agent-judge
description: "(SDD Agent) Evaluate artifacts against weighted rubrics and pass/fail thresholds for SDD quality gates. Also invoked as $sdd-agent:judge."
---
