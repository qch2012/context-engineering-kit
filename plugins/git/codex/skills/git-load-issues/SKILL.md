...
description: "Load all open issues from GitHub and save them as markdown files Argument hint: None required - loads all open issues automatically. Also invoked as $git:load-issues."
---
