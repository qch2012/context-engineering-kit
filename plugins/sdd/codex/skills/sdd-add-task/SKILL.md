---
name: sdd-add-task
description: "(SDD) creates draft task file in .specs/tasks/draft/ with original user intent Argument hint: Task title or description (e.g., \"Add validation to form inputs\") [list of task files that this task depends on]. Also invoked as $sdd:add-task."
---
...
```bash
mkdir -p .specs/tasks/draft .specs/tasks/todo .specs/tasks/in-progress .specs/tasks/done .specs/scratchpad .specs/analysis .specs/research .specs/plans
```
