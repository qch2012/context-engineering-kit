---
name: git-commit
description: "Create well-formatted commits with conventional commit messages and emoji Argument hint: Optional flags like --no-verify to skip pre-commit checks. Also invoked as $git:commit."
---
...
- **Present tense, imperative mood**: file operations commit messages as commands (e.g., "add feature" not "added feature")
