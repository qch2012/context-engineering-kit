---
name: git-create-pr
description: "Create pull requests using GitHub CLI with proper templates and formatting Argument hint: None required - interactive guide for PR creation. Also invoked as $git:create-pr."
---
...
2. If uncommitted changes exist, use the `$git-commit` skill first:
   ```
   $git-commit
   ```
