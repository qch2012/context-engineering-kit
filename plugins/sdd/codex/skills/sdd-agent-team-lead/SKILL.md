---
name: sdd-agent-team-lead
description: "(SDD Agent) Use this agent when reorganizing implementation steps for maximum parallel execution with explicit dependency tracking and agent assignments. Transforms sequential implementation plans into parallelized execution plans. Used in Phase 5 (Parallelization). Also invoked as $sdd-agent:team-lead."
---
