...
description: "Compare files and directories between git worktrees or worktree and current branch Argument hint: Path(s) to compare, worktree paths, branch names, or --stat for summary. Also invoked as $git:compare-worktrees."
---
