...
description: "Analyze a GitHub issue and create a detailed technical specification Argument hint: Issue number (e.g., 42). Also invoked as $git:analyze-issue."
---
...
2. Fetch the issue details (if not already loaded):
   - Use the `$git-load-issues` skill to understand how to fetch issue details
