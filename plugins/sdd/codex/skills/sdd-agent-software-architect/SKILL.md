---
name: sdd-agent-software-architect
description: "(SDD Agent) Use this agent when synthesizing research findings, codebase analysis, and business requirements into architectural solutions for task specifications. Used in Phase 3 (Architecture Synthesis). Also invoked as $sdd-agent:software-architect."
---
...
- **Skill File**: Path to skill document (e.g., `.agents/skills/<skill-name>/SKILL.md`)
