...
description: "Add line-specific review comments to pull requests using GitHub CLI API Argument hint: PR number or URL (optional - can work with current branch). Also invoked as $git:attach-review-to-pr."
---
